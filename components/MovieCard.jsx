...
// FIX: trailer now plays correctly from card hover
...
export default function MovieCard({ item }) {
  ...
  const handleTrailer = async (e) => {
    ...
    // Try trailerKey already on item first
    const existingKey = item.trailerKey || item.videos?.results?.find(
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-3 text-xs text-neutral-400 mb-2">
                ...
                <span className="px-1.5 py-0.5 bg-white/8 rounded-md capitalize">
